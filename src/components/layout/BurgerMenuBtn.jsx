export default function BurgerMenuBtn({ isOpen, setIsOpen }) {
  return (
    ...
    >
      <div
        className={`relative w-8 h-8 md:w-10 md:h-10 border-2 border-black transition-all duration-300 ${
          isOpen ? "bg-red-400 hover:bg-white" : "hover:bg-white"
        }`}
      >
        {/* Top bar */}
        <span
          className={`absolute h-0.5 w-5 md:w-6 bg-black transform transition-all duration-300 ease-in-out ${
            isOpen
              ...
              : "bg-black rotate-0 top-[10px] md:top-[13px] left-[4px] md:left-[6px]"
          }`}
        />
        ...
        <span
          className={`absolute h-0.5 w-5 md:w-6 bg-black    transform transition-all duration-300 ease-in-out ${
            isOpen
              ...
              : "bg-black rotate-0 top-[16px] md:top-[21px] left-[4px] md:left-[6px]"
          }`}
        />
      </div>
    </button>
